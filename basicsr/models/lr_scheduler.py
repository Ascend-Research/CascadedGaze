...
class CosineAnnealingRestartLR(_LRScheduler):
    ...
    def get_lr(self):
        ...
        # if self.eta_min == 0.00015:
        #     print("worked")
        #     return [
        #     self.eta_min + current_weight * 0.5 * (0.00015 - self.eta_min) *
        #     (1 + math.cos(math.pi * (
        #         (self.last_epoch - nearest_restart) / current_period)))
        #     for base_lr in self.base_lrs
        # ]
...
class CosineAnnealingRestartCyclicLR(_LRScheduler):
    ...
    def get_lr(self):
        ...
        current_period = self.periods[idx]
        eta_min = self.eta_mins[idx]
        eta_maxs = self.eta_maxs[idx]
        return [
            eta_min + current_weight * 0.5 * (eta_maxs - eta_min) *
            (1 + math.cos(math.pi * (
                (self.last_epoch - nearest_restart) / current_period)))
